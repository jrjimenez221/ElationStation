...
function Portfolio() {
  return (
      ...
      <div id="ediv" className="col-12 col-md-5 mr-5 align-self-center">
        ...
        <h3 className="text-center">Linked In Username<span className="npcName">(Jose R. Jimenez)</span></h3>
        ...
        <ul class="nav justify-content-center">
          ...
          <svg id="DelFootImg" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-linkedin m-2" viewBox="0 0 16 16">
