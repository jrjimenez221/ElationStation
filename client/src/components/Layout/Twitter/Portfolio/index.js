...
function Portfolio() {
  return (
      ...
      <div id="ediv" className="col-12 col-md-9 align-self-center">
        ...
        <ul class="nav justify-content-center">
          ...
          <svg id="DelFoot" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter m-2" viewBox="0 0 16 16">
